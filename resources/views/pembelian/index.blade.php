            ...
            <form id="formTransaksi" method="post" action="pembelian">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#FormInputModal"> <i class="fas fa-plus"></i> Tambah Data</button>
                ...
                <div class="row justify-content-end" style="text-align: right;">
                    ...
                    <div class="col-md-3 mr-md-auto" style="padding-right: 10px;align-content: right;">
                        <input class="form-control col-md-8 col-xs-12" name="total" style="margin-left: 80px;" required="required" type="text" id="totalHarga">
                    </div>
                </div>
                <div class="row">
